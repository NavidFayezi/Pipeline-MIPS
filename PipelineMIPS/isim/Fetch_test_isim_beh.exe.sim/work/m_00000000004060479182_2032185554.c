...
LAB8:    xsi_set_current_line(35, ng0);
    ...
    t21 = ((char*)((ng4)));
    memset(t18, 0, 8);
    xsi_vlog_signed_add(t18, 32, t20, 32, t21, 32);
    xsi_vlog_generic_convert_array_indices(t5, t16, t6, t14, 2, 1, t18, 32, 1);
    t22 = (t5 + 4);
    t7 = *((unsigned int *)t22);
    t31 = (!(t7));
    t23 = (t16 + 4);
...
LAB9:    t9 = *((unsigned int *)t5);
    ...
    t38 = (t9 - t10);
    t39 = (t38 + 1);
    xsi_vlogvar_assign_value(t2, t1, 0, *((unsigned int *)t16), t39);
    goto LAB10;
...
{
	static char *pe[] = {(void *)Initial_29_0,(void *)Always_41_1};
	xsi_register_didat("work_m_00000000004060479182_2032185554", "isim/Fetch_test_isim_beh.exe.sim/work/m_00000000004060479182_2032185554.didat");
