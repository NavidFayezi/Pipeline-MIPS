...
#endif
static const char *ng0 = "C:/Users/Markazi.co/Desktop/Computer architecture Lab/PipelineMIPS/ALU.v";
...
LAB20:    t360 = (t0 + 3512);
    ...
    *((unsigned int *)t370) = (t372 | t366);
    xsi_driver_vfirst_trans(t360, 0, 15);
    t373 = (t0 + 3416);
    *((int *)t373) = 1;
...
LAB12:    t33 = (t0 + 1048U);
    ...
    t35 = *((char **)t33);
    memset(t36, 0, 8);
    xsi_vlog_unsigned_add(t36, 32, t34, 16, t35, 16);
    goto LAB13;
...
LAB29:    t71 = (t0 + 1048U);
    ...
    t73 = *((char **)t71);
    memset(t74, 0, 8);
    xsi_vlog_unsigned_minus(t74, 32, t72, 16, t73, 16);
    goto LAB30;
...
LAB55:    t119 = *((unsigned int *)t109);
    *((unsigned int *)t109) = (t119 & 4294967295U);
    t120 = *((unsigned int *)t110);
    *((unsigned int *)t110) = (t120 & 4294967295U);
    goto LAB47;
...
LAB68:    if (*((unsigned int *)t152) > 0)
        goto LAB69;

LAB70:    if (*((unsigned int *)t126) > 0)
        goto LAB71;

LAB72:    memcpy(t125, t164, 8);

LAB73:    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t79, 32, t109, 32, t125, 32);
    goto LAB54;

LAB52:    memcpy(t79, t109, 8);
    goto LAB54;

LAB56:    t115 = *((unsigned int *)t109);
    t116 = *((unsigned int *)t112);
    *((unsigned int *)t109) = (t115 | t116);
    t117 = *((unsigned int *)t110);
    t118 = *((unsigned int *)t112);
    *((unsigned int *)t110) = (t117 | t118);
    goto LAB55;
...
LAB65:    t156 = (t0 + 1048U);
    ...
    t158 = *((char **)t156);
    memset(t159, 0, 8);
    xsi_vlog_unsigned_lshift(t159, 32, t157, 16, t158, 16);
    goto LAB66;
...
LAB75:    *((unsigned int *)t167) = 1;

LAB77:    memset(t165, 0, 8);
    t183 = (t167 + 4);
...
LAB87:    if (*((unsigned int *)t165) > 0)
        goto LAB88;

LAB89:    memcpy(t164, t202, 8);

LAB90:    goto LAB68;

LAB69:    xsi_vlog_unsigned_bit_combine(t125, 32, t159, 32, t164, 32);
    goto LAB73;

LAB71:    memcpy(t125, t159, 8);
    goto LAB73;
...
LAB82:    t194 = (t0 + 1048U);
    ...
    t196 = *((char **)t194);
    memset(t197, 0, 8);
    xsi_vlog_unsigned_rshift(t197, 32, t195, 16, t196, 16);
    goto LAB83;
...
LAB92:    *((unsigned int *)t205) = 1;

LAB94:    memset(t203, 0, 8);
    t221 = (t205 + 4);
...
LAB106:    memcpy(t202, t270, 8);

LAB107:    goto LAB85;

LAB86:    xsi_vlog_unsigned_bit_combine(t164, 32, t197, 32, t202, 32);
    goto LAB90;

LAB88:    memcpy(t164, t197, 8);
    goto LAB90;
...
LAB112:    *((unsigned int *)t274) = 1;

LAB114:    memset(t271, 0, 8);
    t290 = (t274 + 4);
...
LAB122:    if (*((unsigned int *)t297) > 0)
        goto LAB123;

LAB124:    if (*((unsigned int *)t271) > 0)
        goto LAB125;

LAB126:    memcpy(t270, t335, 8);

LAB127:    goto LAB102;

LAB103:    xsi_vlog_unsigned_bit_combine(t202, 32, t235, 32, t270, 32);
    goto LAB107;

LAB105:    memcpy(t202, t235, 8);
    goto LAB107;

LAB108:    t246 = *((unsigned int *)t235);
...
LAB135:    if (*((unsigned int *)t338) < *((unsigned int *)t339))
        goto LAB133;

LAB134:    memset(t336, 0, 8);
    t343 = (t340 + 4);
...
LAB137:    if (*((unsigned int *)t343) != 0)
        goto LAB138;

LAB139:    t350 = (t336 + 4);
    t351 = *((unsigned int *)t336);
    t352 = *((unsigned int *)t350);
    t353 = (t351 || t352);
    if (t353 > 0)
        goto LAB140;

LAB141:    t355 = *((unsigned int *)t336);
    t356 = (~(t355));
...
LAB143:    if (*((unsigned int *)t350) > 0)
        goto LAB144;

LAB145:    if (*((unsigned int *)t336) > 0)
        goto LAB146;

LAB147:    memcpy(t335, t359, 8);

LAB148:    goto LAB122;

LAB123:    xsi_vlog_unsigned_bit_combine(t270, 32, t304, 32, t335, 32);
    goto LAB127;

LAB125:    memcpy(t270, t304, 8);
    goto LAB127;

LAB128:    t315 = *((unsigned int *)t304);
...
LAB140:    t354 = ((char*)((ng8)));
    goto LAB141;

LAB142:    t359 = ((char*)((ng9)));
    goto LAB143;

LAB144:    xsi_vlog_unsigned_bit_combine(t335, 32, t354, 32, t359, 32);
    goto LAB148;

LAB146:    memcpy(t335, t354, 8);
    goto LAB148;
...
extern void work_m_00000000001370132351_0886308060_init()
{
	static char *pe[] = {(void *)Cont_24_0,(void *)Cont_33_1};
	xsi_register_didat("work_m_00000000001370132351_0886308060", "isim/MIPS_test_isim_beh.exe.sim/work/m_00000000001370132351_0886308060.didat");
